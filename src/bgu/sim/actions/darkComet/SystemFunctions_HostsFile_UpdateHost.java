...
public class SystemFunctions_HostsFile_UpdateHost extends AbsDeviceAction {
    ...
    public SystemFunctions_HostsFile_UpdateHost() {
	super("SystemFunctions_HostsFile_UpdateHost", new IndicativeFeature[]{});
	readCSV rc = new readCSV();
	events = rc.readCSV("DM_SystemFunctions_HostsFile_UpdateHost.CSV");
    }
