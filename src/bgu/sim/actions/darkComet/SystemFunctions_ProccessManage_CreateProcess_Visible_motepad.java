...
public class SystemFunctions_ProccessManage_CreateProcess_Visible_motepad extends AbsDeviceAction {
    ...
    public SystemFunctions_ProccessManage_CreateProcess_Visible_motepad() {
	super("SystemFunctions_ProccessManage_CreateProcess_Visible_motepad", new IndicativeFeature[]{});
	readCSV rc = new readCSV();
	events = rc.readCSV("DM_SystemFunctions_ProccessManage_CreateProcess_Visible_motepad.CSV");
    }
