...
public class SystemFunctions_ProccessManage_CreateProcess_Visible_mspaint extends AbsDeviceAction {
    ...
    public SystemFunctions_ProccessManage_CreateProcess_Visible_mspaint() {
	super("SystemFunctions_ProccessManage_CreateProcess_Visible_mspaint", new IndicativeFeature[]{});
	readCSV rc = new readCSV();
	events = rc.readCSV("DM_SystemFunctions_ProccessManage_CreateProcess_Visible_mspaint.CSV");
    }
