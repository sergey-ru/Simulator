...
public class SystemFunctions_ProccessManage_RefreshList extends AbsDeviceAction {
    ...
    public SystemFunctions_ProccessManage_RefreshList() {
	super("SystemFunctions_ProccessManage_RefreshList", new IndicativeFeature[]{});
	readCSV rc = new readCSV();
	events = rc.readCSV("DM_SystemFunctions_ProccessManage_RefreshList.CSV");
    }
