...
public class SystemFunctions_RemoteRegistry_DeleteCurentKey extends AbsDeviceAction {
    ...
    public SystemFunctions_RemoteRegistry_DeleteCurentKey() {
	super("SystemFunctions_RemoteRegistry_DeleteCurentKey", new IndicativeFeature[]{});
	readCSV rc = new readCSV();
	events = rc.readCSV("DM_SystemFunctions_RemoteRegistry_DeleteCurentKey.CSV");
    }
