...
public class SystemFunctions_RemoteRegistry_DeleteValue extends AbsDeviceAction {
    ...
    public SystemFunctions_RemoteRegistry_DeleteValue() {
	super("SystemFunctions_RemoteRegistry_DeleteValue", new IndicativeFeature[]{});
	readCSV rc = new readCSV();
	events = rc.readCSV("DM_SystemFunctions_RemoteRegistry_DeleteValue.CSV");
    }
