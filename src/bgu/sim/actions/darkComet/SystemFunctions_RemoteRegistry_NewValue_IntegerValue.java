...
public class SystemFunctions_RemoteRegistry_NewValue_IntegerValue extends AbsDeviceAction {
    ...
    public SystemFunctions_RemoteRegistry_NewValue_IntegerValue() {
	super("SystemFunctions_RemoteRegistry_NewValue_IntegerValue", new IndicativeFeature[]{});
	readCSV rc = new readCSV();
	events = rc.readCSV("DM_SystemFunctions_RemoteRegistry_NewValue_IntegerValue.CSV");
    }
