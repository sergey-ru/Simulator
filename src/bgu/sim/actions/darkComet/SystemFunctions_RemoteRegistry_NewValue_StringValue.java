...
public class SystemFunctions_RemoteRegistry_NewValue_StringValue extends AbsDeviceAction {
    ...
    public SystemFunctions_RemoteRegistry_NewValue_StringValue() {
	super("SystemFunctions_RemoteRegistry_NewValue_StringValue", new IndicativeFeature[]{});
	readCSV rc = new readCSV();
	events = rc.readCSV("DM_SystemFunctions_RemoteRegistry_NewValue_StringValue.CSV");
    }
