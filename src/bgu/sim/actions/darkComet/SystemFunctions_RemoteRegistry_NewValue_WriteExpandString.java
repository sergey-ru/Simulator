...
public class SystemFunctions_RemoteRegistry_NewValue_WriteExpandString extends AbsDeviceAction {
    ...
    public SystemFunctions_RemoteRegistry_NewValue_WriteExpandString() {
	super("SystemFunctions_RemoteRegistry_NewValue_WriteExpandString", new IndicativeFeature[]{});
	readCSV rc = new readCSV();
	events = rc.readCSV("DM_SystemFunctions_RemoteRegistry_NewValue_WriteExpandString.CSV");
    }
