...
public class SystemFunctions_UninstallApplications_RefreshApplList extends AbsDeviceAction {
    ...
    public SystemFunctions_UninstallApplications_RefreshApplList() {
	super("SystemFunctions_UninstallApplications_RefreshApplList", new IndicativeFeature[]{});
	readCSV rc = new readCSV();
	events = rc.readCSV("DM_SystemFunctions_UninstallApplications_RefreshApplList.CSV");
    }
