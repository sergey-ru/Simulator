...
public class SystemInfo_ComputerInformation extends AbsDeviceAction {
    ...
    public SystemInfo_ComputerInformation() {
	super("SystemInfo_ComputerInformation", new IndicativeFeature[]{});
	readCSV rc = new readCSV();
	events = rc.readCSV("DM_SystemInfo_ComputerInformation.CSV");
    }
