...
public class SystemInfo_TraceMap extends AbsDeviceAction {
    ...
    public SystemInfo_TraceMap() {
        super("SystemInfo_TraceMap", new IndicativeFeature[]{});
        readCSV rc = new readCSV();
        events = rc.readCSV("DM_SystemInfo_TraceMap.CSV");
    }
